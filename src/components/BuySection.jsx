...
function BuySection() {
  return (
    ...
    >
      <div className="w-full flex justify-center items-center pt-[100px] px-4">
        ...
        <div className="w-full max-w-[652px]">
          ...
          <div className="flex flex-col md:flex-row gap-3">
            {/* Connect Wallet */}
            <button
              className="w-full h-[55px] md:h-[61px] bg-[#00136A] text-[18px] md:text-[20px] font-bold cursor-pointer hover:scale-95 transition-all border border-[#0759FF] rounded-2xl"
            >
              Connect Wallet
            </button>
            ...
            <button className="relative w-full h-[55px] md:h-[62px] text-white text-[18px] md:text-[20px] font-bold rounded-2xl p-0.5 cursor-pointer hover:scale-95 transition-all bg-gradient-to-r from-[#1F9FC6] via-[#2C175C] to-[#4B275E]">
              <span
                className="flex items-center justify-center w-full h-full rounded-xl bg-gradient-to-r from-[#4B275E] via-[#2C175C] to-[#1F9FC6]"
              >
                Buy now
              </span>
            </button>
